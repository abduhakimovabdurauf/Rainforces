...
const projects = projectsStore.getByServiceId(9);
</script>
    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <NuxtLink
          ...
          class="group relative h-[600px] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.02]"
        >
          <NuxtImg
            :src="project?.images?.[0]"
            :alt="project.name"
            fallback="https://via.placeholder.com/800x600?text=Project+Image"
